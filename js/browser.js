...
var BrowserDetection = {
	...
	noticeText: {
    	   'professional': { "title": "Вы пользуетесь устаревшим браузером!", "notice": "Наш сайт обнаружил, что Вы пользуетесь устаревшим браузером. Для корректного отображения содержимого, а также в целях безопасности, предлагаем обновить свой браузер до последней версии.", "selectBrowser": "Перейдите по ссылкам ниже для скачивания браузера.", "remindMeLater": "Напомнить позже", "neverRemindAgain": "Не напоминать больше" }
	}
};
